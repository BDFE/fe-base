 ...
 *
 * @param {string} id
 * @param {Object} source A source definition object compliant with [`minemap-style-spec`](https://www.minedata.cn/minemap-style-spec/#sources) or, for a third-party source type, with that type's requirements.
