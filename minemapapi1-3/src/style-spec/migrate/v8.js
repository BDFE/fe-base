...
module.exports = function(style) {
    ...
    eachLayer(style, (layer) => {
        ...
        // https://github.com/minemap/minemap-style-spec/issues/255
    ...
    function migrateFontstackURL(input) {
        ...
        if (inputParsed.protocol !== 'minemap:') {
            return input;

        } else if (inputParsed.hostname === 'fontstack') {
            assert(decodeURI(inputParsed.pathname) === '/{fontstack}/{range}.pbf');
            return 'minemap://fonts/minemap/{fontstack}/{range}.pbf';
            ...
            return `minemap://fonts/${inputPathnameParts[2]}/{fontstack}/{range}.pbf`;
