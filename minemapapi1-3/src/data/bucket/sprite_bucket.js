...
const spriteInterface = {
    ...
    paintAttributes: [
        {property: 'sprite-color', type: 'Uint8'},
        {property: 'sprite-blur', multiplier: 10, type: 'Uint8'},
        {property: 'sprite-opacity', multiplier: 10, type: 'Uint8'},
        {property: 'sprite-gap-width', multiplier: 10, type: 'Uint8', name: 'a_gapwidth'},
        {property: 'sprite-offset', multiplier: 1, type: 'Int8'},
    ],
 ...
 * @private
 */
class SpriteBucket extends Bucket {
    constructor(options) {
        super(options, spriteInterface);
    }

    addFeature(feature) {
        const layout = this.layers[0].layout;
        const join = layout['sprite-join'];
        const cap = layout['sprite-cap'];
        const miterLimit = layout['sprite-miter-limit'];
        const roundLimit = layout['sprite-round-limit'];
...
SpriteBucket.programInterface = spriteInterface;
