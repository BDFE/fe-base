...
const extrusionInterface = {
    ...
    paintAttributes: [
        {property: 'extrusion-base',   type: 'Uint16'},
        {property: 'extrusion-height', type: 'Uint16'},
        {property: 'extrusion-color',  type: 'Uint8'}
    ]
};
...
class ExtrusionBucket extends Bucket {
    constructor(options) {
        super(options, extrusionInterface);
    }
...
ExtrusionBucket.programInterface = extrusionInterface;
