...
const histogramInterface = {
    ...
    paintAttributes: [
        {property: 'histogram-base',   type: 'Uint16'},
        {property: 'histogram-height', type: 'Uint16'},
        {property: 'histogram-color',  type: 'Uint8'}
    ]
};
...
class HistogramBucket extends Bucket {
    constructor(options) {
        super(options, histogramInterface);
    }
...
HistogramBucket.programInterface = histogramInterface;
