 ...
 * both, [Minemap Shaders](https://github.com/minemap/minemap-shaders) defines a `#pragma`
...
class ProgramConfiguration {
    ...
    applyPragmas(source, shaderType) {
        return source.replace(/#pragma minemap: ([\w]+) ([\w]+) ([\w]+) ([\w]+)/g, (match, operation, precision, type, name) => {
