 ...
 *
 * @param {Map} map The minemap js map to add the handler to.
 */
 ...
 * @instance
 * @property {MapMouseEvent | MapTouchEvent} data
 * @see [Update a choropleth layer by zoom level](https://www.minedata.cn/minemap-js/example/updating-choropleth/)
 */
