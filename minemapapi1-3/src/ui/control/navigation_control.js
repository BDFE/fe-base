 ...
 * @implements {IControl}
 * @example
 * var nav = new minemap.NavigationControl();
 * map.addControl(nav, 'top-left');
 * @see [Display map navigation controls](https://www.minedata.cn/minemap-js/example/navigation/)
 * @see [Add a third party vector tile source](https://www.minedata.cn/minemap-js/example/third-party/)
 */
