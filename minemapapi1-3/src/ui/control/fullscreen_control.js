 ...
 * @implements {IControl}
 * @example
 * map.addControl(new minemap.FullscreenControl());
 * @see [View a fullscreen map](https://www.minedata.cn/minemap-js/example/fullscreen/)
 */
...
class FullscreenControl {
    ...
    onAdd(map) {
        ...
        const container = this._container = DOM.create('div', `${className} minemap-ctrl-group`);
