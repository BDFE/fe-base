 ...
 *   .setLngLat([30.5, 50.5])
 *   .addTo(map);
 * @see [Add custom icons with Markers](https://www.minedata.cn/minemap-js/example/custom-marker-icons/)
 */
class Marker {
    ...
    constructor(element, options) {
        ...
        element.classList.add('minemap-marker');
     ...
     * @example
     * var marker = new minemap.Marker().addTo(map);
     * marker.remove();
     * @returns {Marker} `this`
     */
    remove() {
