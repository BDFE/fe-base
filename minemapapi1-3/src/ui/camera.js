...
class Camera extends Evented {
     ...
     * @example
     * map.setCenter([-74, 38]);
     * @see [Move symbol with the keyboard](https://www.minedata.cn/minemap-js/example/rotating-controllable-marker/)
     */
     ...
     * @fires moveend
     * @returns {Map} `this`
     * @see [Navigate the map with game-like controls](https://www.minedata.cn/minemap-js/example/game-controls/)
     */
     ...
     * });
     * @see [Fit a map to a bounding box](https://www.minedata.cn/minemap-js/example/fitbounds/)
     */
    ...
    *            Accepts [CameraOptions](#CameraOptions) and [AnimationOptions](#AnimationOptions).
     ...
     *   }
     * });
     * @see [Fly to a location](https://www.minedata.cn/minemap-js/example/flyto/)
     * @see [Slowly fly to a location](https://www.minedata.cn/minemap-js/example/flyto-options/)
     * @see [Fly to a location based on scroll position](https://www.minedata.cn/minemap-js/example/scroll-fly-to/)
     */
