...
const isSupported = require('minemap-supported');
//hack me
 ...
 * Then minemap js initializes the map on the page and returns your `Map`
 * object.
 *
 * @extends Evented
 * @param {Object} options
 * @param {HTMLElement|string} options.container The HTML element in which minemap js will render the map, or the element's string `id`. The specified element must have no children.
 ...
 * @param {Object|string} [options.style] The map's minemap style. This must be an a JSON object conforming to
 * the schema described in the [minemap Style Specification](https://minedata.cn/minemap-style-spec/), or a URL to
 * such JSON.
 *
 * To load a style from the minemap API, you can use a URL of the form `minemap://styles/:owner/:style`,
 * where `:owner` is your minemap account name and `:style` is the style ID. Or you can use one of the following
 * [the predefined minemap styles](https://www.minedata.cn/maps/):
 *
 *  * `minemap://styles/minemap/streets-v9`
 *  * `minemap://styles/minemap/outdoors-v9`
 *  * `minemap://styles/minemap/light-v9`
 *  * `minemap://styles/minemap/dark-v9`
 *  * `minemap://styles/minemap/satellite-v9`
 *  * `minemap://styles/minemap/satellite-streets-v9`
 *
 * Tilesets hosted with minemap can be style-optimized if you append `?optimize=true` to the end of your style URL, like `minemap://styles/minemap/streets-v9?optimize=true`.
 * Learn more about style-optimized vector tiles in our [API documentation](https://www.minedata.cn/api-documentation/#retrieve-tiles).
 *
 ...
 * @param {Array<string>} [options.classes] minemap style class names with which to initialize the map.
 *   Keep in mind that these classes are used for controlling a style layer's paint properties, so are *not* reflected
 *   in an HTML element's `class` attribute. To learn more about minemap style classes, read about
 *   [Layers](https://www.minedata.cn/minemap-style-spec/#layers) in the style specification.
 * @param {boolean} [options.attributionControl=true] If `true`, an [AttributionControl](#AttributionControl) will be added to the map.
 * @param {boolean} [options.logoPosition='bottom-left'] Position of the minemap wordmark on the map. Valid options are ['top-left','top-right', 'bottom-left', 'bottom-right'].
 * @param {boolean} [options.failIfMajorPerformanceCaveat=false] If `true`, map creation will fail if the performance of minemap
 ...
 * @param {LngLatLike} [options.center=[0, 0]] The inital geographical centerpoint of the map. If `center` is not specified in the constructor options, minemap js will look for it in the map's style object. If it is not specified in the style, either, it will default to `[0, 0]`.
 * @param {number} [options.zoom=0] The initial zoom level of the map. If `zoom` is not specified in the constructor options, minemap js will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
 * @param {number} [options.bearing=0] The initial bearing (rotation) of the map, measured in degrees counter-clockwise from north. If `bearing` is not specified in the constructor options, minemap js will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
 * @param {number} [options.pitch=0] The initial pitch (tilt) of the map, measured in degrees away from the plane of the screen (0-60). If `pitch` is not specified in the constructor options, minemap js will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
...
class Map extends Camera {
     ...
     * @returns {Map} `this`
     * @see [Display map navigation controls](https://www.minedata.cn/minemap-js/example/navigation/)
     */
    ...
    /**
     * Adds a minemap style class to the map.
     *
     * Keep in mind that these classes are used for controlling a style layer's paint properties, so are *not* reflected
     * in an HTML element's `class` attribute. To learn more about minemap style classes, read about
     * [Layers](https://www.minedata.cn/minemap-style-spec/#layers) in the style specification.
     *
     * **Note:** Style classes are deprecated and will be removed in an upcoming release of minemap js.
     *
    ...
    addClass(klass, options) {
        util.warnOnce('Style classes 在未来版本可能会删掉.');
    ...
    /**
     * Removes a minemap style class from the map.
     *
     * **Note:** Style classes are deprecated and will be removed in an upcoming release of minemap js.
     *
    ...
    /**
     * Replaces the map's existing minemap style classes with a new array of classes.
     *
     * **Note:** Style classes are deprecated and will be removed in an upcoming release of minemap js.
     *
    ...
    /**
     * Returns the map's minemap style classes.
     *
     * **Note:** Style classes are deprecated and will be removed in an upcoming release of minemap js.
     *
     ...
     * @see [Show polygon information on click](https://www.minedata.cn/minemap-js/example/polygon-popup-on-click/)
     */
    unproject(point) {
     ...
     * @param {Array} [parameters.filter] A [filter](https://www.minedata.cn/minemap-style-spec/#types-filter)
     ...
     * @see [Get features under the mouse pointer](https://www.minedata.cn/minemap-js/example/queryrenderedfeatures/)
     * @see [Highlight features within a bounding box](https://www.minedata.cn/minemap-js/example/using-box-queryrenderedfeatures/)
     * @see [Center the map on a clicked symbol](https://www.minedata.cn/minemap-js/example/center-on-symbol/)
     */
     ...
     * will be returned as a separate feature. Similarly, a point feature near a tile boundary may appear in multiple
     * tiles due to tile buffering.
     * @see [Filter features within map view](https://www.minedata.cn/minemap-js/example/filter-features-within-map-view/)
     * @see [Highlight features containing similar data](https://www.minedata.cn/minemap-js/example/query-similar-features/)
     */
    ...
    /**
     * Updates the map's minemap style object with a new value.  If the given
     ...
     *   [minemap Style Specification](https://minedata.cn/minemap-style-spec/), or a URL to such JSON.
     * @param {Object} [options]
     * @param {boolean} [options.diff=true] If false, force a 'full' update, removing the current style
     *   and adding building the given one instead of attempting a diff-based update.
     * @returns {Map} `this`
     * @see [Change a map's style](https://www.minedata.cn/minemap-js/example/setstyle/)
     */
    setStyle(style, options) {
        //hack me
        if(typeof style === 'string'){
            if(parseInt(style.substr(style.lastIndexOf('\/')+1)) !== config.SOLU){
                alert('请检查minemap.solution与style处的solution号码是否匹配');
                return;
            }
        }
    ...
    /**
     * Returns the map's minemap style object, which can be used to recreate the map's style.
     *
     ...
     * minemap Style Specification's [source definition](https://www.minedata.cn/minemap-style-spec/#sources).
     * @param {string} source.type The source type, which must be either one of the core minemap GL source types defined in the style specification or a custom type that has been added to the map with {@link Map#addSourceType}.
     * @fires source.add
     * @returns {Map} `this`
     * @see [Draw GeoJSON points](https://www.minedata.cn/minemap-js/example/geojson-markers/)
     * @see [Style circles using data-driven styling](https://www.minedata.cn/minemap-js/example/data-driven-circle-colors/)
     * @see [Set a point after Geocoder result](https://www.minedata.cn/minemap-js/example/point-from-geocoder-result/)
     */
    addSource(id, source) {
     ...
     * @see [Create a draggable point](https://www.minedata.cn/minemap-js/example/drag-a-point/)
     * @see [Animate a point](https://www.minedata.cn/minemap-js/example/animate-point-along-line/)
     * @see [Add live realtime data](https://www.minedata.cn/minemap-js/example/live-geojson/)
     */
    getSource(id) {
    ...
    /**
     * Adds a [minemap style layer](https://www.minedata.cn/minemap-style-spec/#layers)
     * to the map's style.
     *
     * A layer defines styling for data from a specified source.
     *
     * @param {Object} layer The style layer to add, conforming to the minemap Style Specification's
     *   [layer definition](https://www.minedata.cn/minemap-style-spec/#layers).
     * @param {string} [before] The ID of an existing layer to insert the new layer before.
     *   If this argument is omitted, the layer will be appended to the end of the layers array.
     * @returns {Map} `this`
     * @see [Create and style clusters](https://www.minedata.cn/minemap-js/example/cluster/)
     * @see [Add a vector tile source](https://www.minedata.cn/minemap-js/example/vector-source/)
     * @see [Add a WMS source](https://www.minedata.cn/minemap-js/example/wms/)
     */
     ...
     * @see [Filter symbols by toggling a list](https://www.minedata.cn/minemap-js/example/filter-markers/)
     * @see [Filter symbols by text input](https://www.minedata.cn/minemap-js/example/filter-markers-by-input/)
     */
    getLayer(id) {
     ...
     * @param {Array} filter The filter, conforming to the minemap Style Specification's
     *   [filter definition](https://www.minedata.cn/minemap-style-spec/#types-filter).
     * @returns {Map} `this`
     * @example
     * map.setFilter('my-layer', ['==', 'name', 'USA']);
     * @see [Filter features within map view](https://www.minedata.cn/minemap-js/example/filter-features-within-map-view/)
     * @see [Highlight features containing similar data](https://www.minedata.cn/minemap-js/example/query-similar-features/)
     * @see [Create a timeline animation](https://www.minedata.cn/minemap-js/example/timeline-animation/)
     */
     ...
     *   Must be of a type appropriate for the property, as defined in the [minemap Style Specification](https://www.minedata.cn/minemap-style-spec/).
     * @param {string=} klass A style class specifier for the paint property.
     * @returns {Map} `this`
     * @example
     * map.setPaintProperty('my-layer', 'fill-color', '#faafee');
     * @see [Change a layer's color with buttons](https://www.minedata.cn/minemap-js/example/color-switcher/)
     * @see [Adjust a layer's opacity](https://www.minedata.cn/minemap-js/example/adjust-layer-opacity/)
     * @see [Create a draggable point](https://www.minedata.cn/minemap-js/example/drag-a-point/)
     */
     ...
     * @param {*} value The value of the layout propery. Must be of a type appropriate for the property, as defined in the [minemap Style Specification](https://www.minedata.cn/minemap-style-spec/).
     * @returns {Map} `this`
     * @example
     ...
     *
     * @param {Object} options Light properties to set. Must conform to the [minemap Style Specification](https://www.minedata.cn/minemap-style-spec/).
     * @returns {Map} `this`
     */
     ...
     * @see [Measure distances](https://www.minedata.cn/minemap-js/example/measure/)
     * @see [Display a popup on hover](https://www.minedata.cn/minemap-js/example/popup-on-hover/)
     * @see [Center the map on a clicked symbol](https://www.minedata.cn/minemap-js/example/center-on-symbol/)
     */
    getCanvas() {
        return this._canvas;
    ...
    _setupContainer() {
        ...
        container.classList.add('minemap-map');

        const canvasContainer = this._canvasContainer = DOM.create('div', 'minemap-canvas-container', container);
        if (this._interactive) {
            canvasContainer.classList.add('minemap-interactive');
        }

        this._canvas = DOM.create('canvas', 'minemap-canvas', canvasContainer);
        ...
        const controlContainer = this._controlContainer = DOM.create('div', 'minemap-control-container', container);
        const positions = this._controlPositions = {};
        ['top-left', 'top-right', 'bottom-left', 'bottom-right'].forEach((positionName) => {
            positions[positionName] = DOM.create('div', `minemap-ctrl-${positionName}`, controlContainer);
        });
    }
 ...
 * element, which is often a `div` element. To use minemap js's
 * default control styling, add the `minemap-ctrl` class to your control's
 * node.
 *
 * @interface IControl
 * @example
 ...
 * @example
 * var v1 = new minemap.LngLat(-122.420679, 37.772537);
 ...
 *   new minemap.LngLat(-73.9876, 40.7661),
 *   new minemap.LngLat(-73.9397, 40.8002)
 * );
 * var v2 = new minemap.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002])
 * var v3 = [[-73.9876, 40.7661], [-73.9397, 40.8002]];
 */

/**
 * A [`Point` geometry](https://github.com/minemap/point-geometry) object, which has
 ...
 * @see [Highlight features under the mouse pointer](https://www.minedata.cn/minemap-js/example/hover-styles/)
 */
 ...
 * @instance
 * @property {MapMouseEvent} data
 * @see [Get coordinates of the mouse pointer](https://www.minedata.cn/minemap-js/example/mouse-position/)
 * @see [Highlight features under the mouse pointer](https://www.minedata.cn/minemap-js/example/hover-styles/)
 * @see [Display a popup on hover](https://www.minedata.cn/minemap-js/example/popup-on-hover/)
 */
 ...
 * @instance
 * @property {{originalEvent: DragEvent}} data
 * @see [Play map locations as a slideshow](https://www.minedata.cn/minemap-js/example/playback-locations/)
 * @see [Filter features within map view](https://www.minedata.cn/minemap-js/example/filter-features-within-map-view/)
 */
 ...
 */
  ...
  * - `'style'`: The [style](https://www.minedata.cn/minemap-style-spec/) used by the map
  *
  * @typedef {Object} MapDataEvent
  * @property {string} type The event type.
  * @property {string} dataType The type of data that has changed. One of `'source'`, `'style'`.
  * @property {boolean} [isSourceLoaded] True if the event has a `dataType` of `source` and the source has no outstanding network requests.
  * @property {Object} [source] The [style spec representation of the source](https://www.minedata.cn/minemap-style-spec/#sources) if the event has a `dataType` of `source`.
