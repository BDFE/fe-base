 ...
 *
 * Note that any minemap method that accepts a `LngLatBounds` object as an argument or option
 ...
 * @example
 * var sw = new minemap.LngLat(-73.9876, 40.7661);
 * var ne = new minemap.LngLat(-73.9397, 40.8002);
 * var llb = new minemap.LngLatBounds(sw, ne);
 */
class LngLatBounds {
    constructor(sw, ne) {
        if (!sw) {
     ...
     * @example
     * var llb = new minemap.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002]);
