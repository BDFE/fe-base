...
import {
    MapIndexBase64
} from "../data/MapIndex.js";
import {
    MapOutlineBase64
} from "../data/MapOutline.js";
import {
    Utils
} from "../utils/Utils.js";
...
function EarthSurfaceShader(configure) {
    ...
    function loadSurfaceColor() {
        ...
        setShaderColor(configure.color.surface);

        if (configure.color.selected === null) {

            setHighlightColor(configure.color.surface);

        } else {

            setHighlightColor(configure.color.selected);
