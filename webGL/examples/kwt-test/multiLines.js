...
function initVertexBuffers(gl) {
  ...
  var colors = new Float32Array([   // Colors
    0.2, 0.58, 0.82,   0.2, 0.58, 0.82,   0.2,  0.58, 0.82,  // v0-v1-v2-v3 front
    0.5,  0.41, 0.69,  0.5, 0.41, 0.69,   0.5, 0.41, 0.69,     // v0-v3-v4-v5 right
    0.0,  0.32, 0.61,  0.0, 0.32, 0.61,   0.0, 0.32, 0.61,    // v0-v5-v6-v1 up
    0.78, 0.69, 0.84,  0.78, 0.69, 0.84,  0.78, 0.69, 0.84,   // v1-v6-v7-v2 left
    0.32, 0.18, 0.56,  0.32, 0.18, 0.56,  0.32, 0.18, 0.56,  // v7-v4-v3-v2 down
    0.73, 0.82, 0.93,  0.73, 0.82, 0.93,  0.73, 0.82, 0.93,   // v4-v7-v6-v5 back
   ]);
 ...
 var indices = new Uint8Array([
  ...
  if (!initArrayBuffer(gl, vertices, gl.FLOAT, 3, 'a_Position',0,0)) return -1; // Coordinates
  if (!initArrayBuffer(gl, colors, gl.FLOAT, 3, 'a_Color',0,0)) return -1;      // Color Information
...
function draw(gl, n, currentAngle, viewProjMatrix, u_MvpMatrix) {
  ...
  gl.drawArrays(gl.LINE_STRIP, 0, 8);   // Draw
  // gl.drawArrays(gl.LINE_STRIP, n, gl.UNSIGNED_BYTE, 0);   // Draw
}
...
function initArrayBuffer (gl, data, type, num, attribute,stride=0,offset=0) {
  // Create a buffer object
